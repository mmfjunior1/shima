        		        ...
        		        <form name="frm_main_searching" id="frm_main_searching" method="post" method="post" action="/logonSistema">
                		    ...
                		    <div class="search-job">
        						<div class="search-job-inner" style="margin-top: 27px; background-color:rgba(29, 29, 29, 0.32)">
	                       			<h1 class="text-center" style="margin-bottom:0px; margin-top:0px !important; font-size:29px; background:none; width:100%; text-align: center; padding:0px;color:white; margin-bottom:15px">Informe suas credenciais</h1> 
									 <div class="search-fild" style="border-radius: 5px 0px 0px 5px;">
	                 					<input name="email" id="email" placeholder="email ou cpf" class="select-search" style="text-align:center ; border-radius: 5px 0 0 5px; font-size:17px" />
	          	    				</div>
